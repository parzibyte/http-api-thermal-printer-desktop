...
Su nombre es `ImprimirCodigoDeBarrasEan`, así que ese valor va en la clave `nombre`. Después coloca los argumentos en el arreglo `argumentos`
...
### Área de pruebas
[Pruébalo en el área de pruebas](../area-pruebas.md?operacion=ImprimirCodigoDeBarrasEan)
<Playground urlBase="../.." nombreOperacion="ImprimirCodigoDeBarrasEan" :ocultarOperacionesDisponibles="true"/>
...
```
{"serial":"","nombreImpresora":"your_printers_name","operaciones":[{"nombre":"ImprimirCodigoDeBarrasEan","argumentos":["5012345678900",20,380,0]}]}
```
