...
[Pruébalo en el área de pruebas](../area-pruebas.md?operacion=DeshabilitarCaracteresPersonalizados)
...
```
{"serial":"","nombreImpresora":"Nombre_impresora","operaciones":[{"nombre":"DeshabilitarCaracteresPersonalizados","argumentos":[]}]}
```
