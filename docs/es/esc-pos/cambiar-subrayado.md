...
[Pruébalo en el área de pruebas](../area-pruebas.md?operacion=EstablecerSubrayado)
...
```
{"serial":"","nombreImpresora":"Nombre_impresora","operaciones":[{"nombre":"EstablecerSubrayado","argumentos":[true]}]}
```
