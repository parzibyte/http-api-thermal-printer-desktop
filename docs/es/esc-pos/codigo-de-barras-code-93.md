...
Su nombre es `ImprimirCodigoDeBarrasCode93`, así que ese valor va en la clave `nombre`. Después coloca los argumentos en el arreglo `argumentos`
...
```
{"serial":"","nombreImpresora":"Nombre_impresora","operaciones":[{"nombre":"ImprimirCodigoDeBarrasCode93","argumentos":["D387266D",80,380,0]}]}
```
